...
% Prepare file name
saveTo = [Params.dataFolder Params.version '_' Params.subjectPrefix text '_' ...
...
for frmt = 1:length(Params.fileFormat)
    switch Params.fileFormat{frmt}
        ...
        otherwise
            writetable(struct2table(rmfield(Logger,'vbl')),[saveTo '.' Params.fileFormat{frmt}]);
    ...
    sendmail('yaniv.abir+data@mail.huji.ac.il',...
        ['Data bRMS4: ',Params.subjectPrefix], '',[saveTo '.' Params.fileFormat{frmt}]);
end