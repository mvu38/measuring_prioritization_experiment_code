...
switch Params.location
    ...
    case 'lab3d'
        Display.dimensions = [51 28.8];       % (cm)
        Display.distance = 45;              % Viewing distance (cm)
        Display.reduceCrossTalk = -.19;    % If you want cross-talk reduction b/w sides, specify gain. Otherwise leave empty
        Display.stereoMode = '3d';
