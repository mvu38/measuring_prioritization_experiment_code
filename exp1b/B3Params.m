...
%% General parameters
Params.version = 'UpDownbCFS'; % Name of the experiment for file naming
...
Params.breakEvery = 90;    % Break every x trials
% For bRMS
...
Params.bCFS.stimulus.maxAlpha = 0.35;    % Default maximum stimulus opacity value
Params.bRMS.stimulus.maxAlpha = 0.5;    % Default maximum stimulus opacity value
Params.bCFS.stimulus.fadeInTime = 1;     % Initial time period for stimulus fade in (sec)
Params.bRMS.stimulus.fadeInTime = 0;     % Initial time period for stimulus fade in (sec)
